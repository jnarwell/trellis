...
- **Phase**: 2.12 — differentiator hardening (dimensional analysis, measured uncertainty, real seed loading, read-time inheritance) — see [docs/CURRENT_STATE.md](docs/CURRENT_STATE.md)
