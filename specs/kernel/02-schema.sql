-- =============================================================================
-- Trellis Kernel - PostgreSQL Schema
-- =============================================================================
--
-- This schema defines the database structure for the Trellis kernel.
-- Requirements: PostgreSQL 15+, extensions: uuid-ossp, ltree, pg_trgm
--
-- Key design decisions:
--   - UUIDs v7 (time-ordered) for all primary keys
--   - JSONB for flexible property storage with GIN indexes
--   - ltree for hierarchical type paths
...
-- Comment out in production - useful for development
/*
INSERT INTO tenants (id, name, slug) VALUES
    ('00000000-0000-0000-0000-000000000001', 'Acme Corp', 'acme');

INSERT INTO actors (id, tenant_id, name, email, actor_type) VALUES
    ('00000000-0000-0000-0000-000000000002',
     '00000000-0000-0000-0000-000000000001',
     'System',
     'system@trellis.local',
     'system');

INSERT INTO type_schemas (tenant_id, type_path, name, properties) VALUES
    (NULL, 'entity', 'Base Entity', '[]'),
    (NULL, 'product', 'Product', '[
        {"name": "name", "value_type": "text", "required": true},
        {"name": "sku", "value_type": "text", "required": true},
        {"name": "price", "value_type": "number", "required": false, "dimension": "dimensionless"}
    ]'),
    (NULL, 'product.variant', 'Product Variant', '[
        {"name": "variant_name", "value_type": "text", "required": true},
        {"name": "attributes", "value_type": "record", "required": false}
    ]');
*/
